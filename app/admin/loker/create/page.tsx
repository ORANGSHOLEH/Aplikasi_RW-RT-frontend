...
export default function CreateLokerPage() {
  ...
  const [form, setForm] = useState<LokerFormData>({
    ...
    location: "",
    is_active: true,
    image: "https://placehold.co/600x400/1f2937/white?text=Lowongan+Kerja",
  });
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError("Failed to create Loker");
    } finally {
      setSaving(false);
    }
  };
          ...
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-gray-600">
                Tambahkan lowongan kerja baru ke database
              </p>
            </div>
            <button
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <input
                ...
                required
                className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
                placeholder="Contoh: Bandung, Jakarta, Remote, dll"
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                required
                className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
                placeholder="Contoh: Rp 3.000.000 - 5.000.000, Negotiable, dll"
              />
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                rows={4}
                className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
                placeholder="Contoh: S1 semua jurusan, pengalaman 2 tahun, dll"
              />
            </div>
